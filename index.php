           ...
           <section class="menu active" id="play-menu" data-type="play">
                ...
                <section class="play-section">
                    <div class="play-config-div" id="play-amount-config">
                        <button class="play-config" data-playerAmount="1" disabled style="cursor: not-allowed;opacity: 0.5;">single player</button>
                    ...
                    <div class="play-config-div" id="play-map-config">
                        ...
                        <button class="play-config" data-maptype="custom" disabled style="cursor: not-allowed;opacity: 0.5;">custom</button>
                    </div>
